 ...
 * function:
 */
public class SecondFragment extends Fragment implements LabelView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.event_second_fragment, null);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        labelPresenter.label("1004", 1, 10);
        ...
        mback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 返回主页
                EventBus.getDefault().post(new HomeEvent2());
            }
        });
    }
